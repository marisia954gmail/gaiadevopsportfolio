export const expertiseGroups = [
  { title: 'Application development', description: 'Reliable business logic, database design, and platform work for applications that have to last.', skills: ['PHP & MySQL', 'Laravel MVC & Livewire', 'RESTful API', 'PHPUnit & SOLID'] },
  ...
  { title: 'Infrastructure', description: 'Practical server and cloud foundations that keep production reliable and understandable.', skills: ['LAMP & LEMP', 'AWS', 'Linux', 'WordPress'] },
]
