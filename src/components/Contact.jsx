...
function Contact() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      const response = await fetch('https://sendemail.gaiadevops.com/api/send-email', {
        method: 'POST',
